...
function checkRightBtn() {
  ...
  switch (current_slide) {
    case 1:
      ...
      rightBtnText.innerHTML = 'Projects  <img id="rightImage" src="./assets/images/giphy.gif" />';
      break;
    case 2:
      leftBtn.style.display = 'block';
      rightBtnText.innerHTML = 'About  <img id="rightImage" src="./assets/images/giphy.gif" />'
      leftBtnText.innerHTML = '<img id="leftImage" src="./assets/images/giphy.gif" /> Home'
      break;
    case 3:
      leftBtn.style.display = 'block';
...
function checkPage() {
  if (current_slide === 1) {
    ...
    document.getElementById('rightBtnText').innerHTML = 'Projects  <img id="rightImage" src="./assets/images/giphy.gif" />';
  }
